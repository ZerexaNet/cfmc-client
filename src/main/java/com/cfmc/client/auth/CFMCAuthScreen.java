...
import com.cfmc.client.CFMCConfig;
import com.cfmc.client.auth.impl.HybridAuthStrategy;
import com.cfmc.client.auth.impl.OfflineAuthStrategy;
import com.cfmc.client.auth.impl.SkinServerAuthStrategy;
...
public class CFMCAuthScreen extends Screen {
    ...
    private CFMCAuthService createStrategy() {
        return switch (CFMCConfig.get().authMode) {
            ...
            case "online" -> new com.cfmc.client.auth.impl.OnlineAuthStrategy(
